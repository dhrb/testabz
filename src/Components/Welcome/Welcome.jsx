  ...
  return (
    <div className='welcomeWrapp'>
      <div className="welcomeMain">
        <h1 className='welcomeHeader'>Test assignment for front-end developer</h1>
        <p className='welcomeParagraph'>What defines a good front-end developer is one that has skilled knowledge of 
